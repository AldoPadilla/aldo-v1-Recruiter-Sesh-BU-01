        ...
        bgVideo: function(e) {
            return this.each(function(e) {
                ...
                if (jQuery(window).width() > 1024) {
                    ...
                    r += "bgvideo</video>";
                    r += "</div></div>";
                    r += '<a href="#" class="mute-video" style="position: fixed;z-index:100050; top:10px;left:50%;margin-left: -10px;color:#ffffff;display:block;width: 20px;height: 20px; font-size: 25px;"><i class="fa fa-volume-up fa-fw"></i></a>'
...
jQuery("body").on("click", ".mute-video", function() {
    var e = jQuery(this).siblings(".vid-main").find("video").attr("id");
