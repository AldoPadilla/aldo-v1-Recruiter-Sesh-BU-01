...
function setProportion(i, e, o, d) {
    ...
    i.find(".vid-bg").width(t * e), i.find(".vid-bg").height(t * o), i.find(".vid-bg video").width(t * e), i.find(".vid-bg video").height(t * o);
    var a = (i.width() >> 1) - (i.find(".vid-bg video").width() >> 1) | 0,
        v = (i.height() >> 1) - (i.find(".vid-bg video").height() >> 1) | 0;
...
function getProportion(i, e, o, d) {
    var t = (jQuery(window).width(), jQuery(window).height(), i.width()),
        ...
        r = e / o,
        n = a / o;
    return v >= r ? n = t / e : d && a < jQuery(window).height() && (n = jQuery(window).height() / o), n
}

function parallaxVideo(i) {
    var e = i.visible(!0);
    if (e) {
        var o = parseInt(jQuery(i).offset().top),
    ...
    i.fn.extend({
        bgVideo: function() {
            return this.each(function(i) {
                var e = jQuery(this),
                    o = {
                        videomp4: e.data("videomp4"),
                        videowebm: e.data("videowebm"),
                        videooga: e.data("videooga"),
    ...
    return 0 == e.muted ? (e.muted = !0, jQuery(this).find("i").removeClass("fa-volume-up"), jQuery(this).find("i").addClass("fa-volume-off")) : (e.muted = !1, jQuery(this).find("i").removeClass("fa-volume-off"), jQuery(this).find("i").addClass("fa-volume-up")), !1
});
